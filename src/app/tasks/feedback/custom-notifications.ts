...
export class CustomNotification extends Task {
    ...
    protected async onRun(
        ...
        try {
            ...
            const unparsedMessages = ApplicationSettings.getString(PATIENT_MESSAGES_KEY);
            ...
            getLogger("sendCustomNotificationTask").warn(`Was not possible to send a custom notification. Reason ${e}`)
