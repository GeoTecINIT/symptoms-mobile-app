...
export const confirmWantsToMakeEmergencyCall: ConfirmDialogOptions = {
    ...
    body: "Si has pulsado aquí por error, selecciona CANCELAR. En caso contrario, pulsa CONTINUAR",
...
export const confirmToDiscardExposure: ConfirmDialogOptions = {
    question: "¿Te vas?",
    body: "Puedes realizar una exposición en otro momento. Recuerda que exponerse con frecuencia es la mejor forma de mejorar.",
...
export const confirmWantsToLeave: ConfirmDialogOptions = {
    question: "¿Te vas?",
    body: "Recuerda el papel negativo de la evitación. Es importante mantenerte en la situación hasta que consigas reducir tu nivel de ansiedad.",
...
export const confirmWantsToUnlink: ConfirmDialogOptions = {
    ...
    body: "Si desvinculas este dispositivo tendrás que volver a configurar la app en caso de reinstalación",
    positiveText: "Salir",
    negativeText: "Volver",
};
...
export const confirmWantsToExport: ConfirmDialogOptions = {
    ...
    body: "El proceso puede llevar un tiempo en función del uso que hayas hecho de la app y del tiempo que lleves usándola",
